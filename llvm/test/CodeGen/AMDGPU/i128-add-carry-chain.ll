...
; CHECK-NEXT:    v_addc_co_u32_e64 v2, s[8:9], v40, v0, s[8:9]
; CHECK-NEXT:    v_mov_b32_e32 v0, s7
; CHECK-NEXT:    v_addc_co_u32_e64 v3, s[6:7], v41, v0, s[8:9]
; CHECK-NEXT:    v_lshrrev_b64 v[4:5], s34, v[2:3]
; CHECK-NEXT:    s_lshr_b64 s[6:7], s[4:5], s34
